class SellThings {
    ...
    initPages() {
        this.page = new SellThingsInventoryBlock('<?=getHTML('../views/SellThings.php') ?>');
    }
}

class SellThingsChunk extends Chunk {
    /*------------------------|
     |        FUNCTIONS       |
     |-----------------------*/
    /*-----------------------|
    ...
    initChild() {
        ...
        this.inventoryBlock = new SellThingsInventoryBlock('<?=getHTML('../views/Pawnshop.inventory.php') ?>');
        //
...
class SellThingsInventoryBlock extends Chunk {
    /*-----------------------|
     |         EVENTS         |
     |-----------------------*/
...
class SellThingsPutBlock extends Chunk {
    /*-----------------------|
     |        FUNCTIONS       |
     |-----------------------*/
    getCash(event) {
